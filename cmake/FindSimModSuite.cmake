...
macro(simLibCheck libs isRequired)
  foreach(lib ${libs})
    ...
    if(simlib MATCHES "^simlib-NOTFOUND$")
      ...
      list(APPEND SIMMODSUITE_LIBS ${simlib})
    endif()
  endforeach()
...
if (SIM_PARASOLID)
  ...
  set(MAX_SIM_PARASOLID_VERSION 381)
...
if (Omega_h_USE_SimDiscrete)
  list(PREPEND SIM_CAD_LIB_NAMES SimDiscrete)
endif()
...
if (UNIX AND NOT APPLE)
  ...
  list(APPEND SIMMODSUITE_LIBS ${CMAKE_THREAD_LIBS_INIT})
endif()
...
if (SIM_ARCHOS STREQUAL x64_rhel8_gcc83)
  ...
  if(XDR_LIB)
    ...
    list(APPEND SIMMODSUITE_LIBS ${XDR_LIB})
  else()
